            ...
            <?php
                ...
                if (!$connect){
                  ...
                  $sql ="select * from genre";
                    $query=mysqli_query($connect,"select * from GenreMusic");
                while($row=mysqli_fetch_array($query)){
            ?>
            <tr>
            <td><?php echo $row['GenreID']; ?></td>
            <td><?php echo $row['GenreName']; ?></td>
            <td><button type="button" class="btn btn-outline-success" ><a href="GenreEdit.php?id=<?php echo $row['GenreID']; ?>">Edit</a></button></td>
            <td><button type="button" class="btn btn-outline-warning"><a href="GenreDelete.php?id=<?php echo $row['GenreID']; ?>">Delete</a></button></td>
            </tr>
            <?php
            }
            ?>
