...
<body>
	...
	$connect = mysqli_connect('localhost','root','','Websitemusic');
	 if(isset($_GET['id'])){					
		$SingerID=$_GET['id'];
		$result=$connect->query("select * from singer Where SingerID=$SingerID");
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="form-group">
                ...
                <input class="form-control" value=" <?php if(isset($_GET['id'])){echo "$row->SingerName";} ?>" name="SingerName" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="name">Singer Biography:</label>
                <textarea name="SingerBiography" id="" cols="30" rows="10"> <?php if(isset($_GET['id'])){echo "$row->SingerBiography";} ?></textarea>
            </div>
            <div class="form-group">
        ...
        <?php
            ...
            $result2=$connect->query("UPDATE `singer` SET SingerName='$SingerName', SingerImg='$SingerImg', SingerBiography='$SingerBiography',GenreID='$GenreID' WHERE SingerID='$SingerID'"); 
            if($result2){
